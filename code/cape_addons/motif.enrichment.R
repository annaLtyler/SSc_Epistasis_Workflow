...
motif.enrichment <- function(data.obj, permutations = 10000, sep.main = TRUE, include.covar = FALSE, collapsed.net = TRUE, plot.dist = TRUE, directed = FALSE, count.col = "green", enriched.col = "brown", depleted.col = "blue", pdf.filename = "Motif.Distributions.pdf"){
