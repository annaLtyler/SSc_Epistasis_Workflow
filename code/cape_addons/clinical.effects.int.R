...
clinical.benefits.int <- function(data.obj, clinical.benefit, p.or.q = 0.05, covar = NULL, scan.what = c("normalized.traits", "raw.traits"), geno.coding = c("Additive", "Dominant", "Recessive")){
