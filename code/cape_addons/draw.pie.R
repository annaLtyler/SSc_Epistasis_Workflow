...
draw.pie <- function (x = 0.5, y = 0.5, radius = 1, cols = c("red", "green"), labels = NULL, edges = 200, label.cex = 1, xlim = NULL, ylim = NULL, add = TRUE){
    ...
    for(i in 1:n.pie){
        ...
        polygon(c(P$x, x), c(P$y, y), col = cols[i])
