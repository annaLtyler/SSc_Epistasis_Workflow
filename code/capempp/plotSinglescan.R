...
# data.obj = cross; singlescan.obj = cross.singlescan; chr = NULL; traits = NULL; alpha = c(0.01, 0.05); standardized = TRUE; color.scheme = c("DO/CC","other"); allele.labels = NULL; include.covars = TRUE; show.selected = FALSE; line.type = "l"; lwd = 1

plotSinglescan <- function(data.obj, singlescan.obj, chr = NULL, traits = NULL, alpha = c(0.01, 0.05), standardized = TRUE, color.scheme = c("DO/CC","other"), allele.labels = NULL, include.covars = TRUE, show.selected = FALSE, line.type = "l", lwd = 1, pch = 16, cex = 1, covar.label.size = 0.7){
